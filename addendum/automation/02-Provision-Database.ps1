...
# create Cosmos DB databases and collections
Write-Verbose "Creating DocumentDB Database and Collection"
$connStr = $docDbConnectionString + ";Database=" + $AccountDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $AccountCollection

$connStr = $docDbConnectionString + ";Database=" + $ApplicationDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $ApplicationCollection

$connStr = $docDbConnectionString + ";Database=" + $CustomertDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $CustomerCollection

$connStr = $docDbConnectionString + ";Database=" + $DeviceDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $DeviceCollection

$connStr = $docDbConnectionString + ";Database=" + $ReferenceDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $ReferenceCollection

$connStr = $docDbConnectionString + ";Database=" + $RegistryDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $RegistryCollection

$connStr = $docDbConnectionString + ";Database=" + $SimulationDatabase
$command = $Path + "\Automation\Common\Load-DocDb.ps1"
&$command -Path $Path -DocDbConnStr $connStr -CollectionName $SimulationCollection
