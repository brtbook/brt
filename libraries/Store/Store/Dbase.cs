...
namespace brt.Microservices.Common.Store
{
    public class Dbase : IDbase
    {
        ...
        {
            dynamic response = _client.UpsertDocumentAsync(_collection.SelfLink, model);
        }

        public void Delete(string key)
        {
            var response = _client.DeleteDocumentAsync(UriFactory.CreateDocumentUri(_database.Id, _collection.Id, key));
        }
